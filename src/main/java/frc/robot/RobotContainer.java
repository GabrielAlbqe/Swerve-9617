...
public class RobotContainer {
  ...
  private Joystick controleDriver1 = new Joystick(Constants.Controle.ControleDriver);

  public RobotContainer() {

    // Definimos o comando padrão como a tração
    swerve.setDefaultCommand(swerve.driveCommand(
      () -> MathUtil.applyDeadband(controleDriver1.getRawAxis(1), Constants.Controle.DEADBAND),
      () -> MathUtil.applyDeadband(controleDriver1.getRawAxis(0), Constants.Controle.DEADBAND),
      () -> controleDriver1.getRawAxis(4)));
